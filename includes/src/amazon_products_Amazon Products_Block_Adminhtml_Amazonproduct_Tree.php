 ...
 */
class amazon_products_Amazon Products_Block_Adminhtml_Amazonproduct_Tree extends amazon_products_Amazon Products_Block_Adminhtml_Amazonproduct_Abstract
{
    /**
     * constructor
     *
    ...
    {
        parent::__construct();
        $this->setTemplate('amazon_products_amazon products/amazonproduct/tree.phtml');
     ...
     *
     * @access protected
     * @return amazon_products_Amazon Products_Block_Adminhtml_Amazonproduct_Tree
     * @author Ultimate Module Creator
     */
    protected function _prepareLayout()
    {
        ...
        $this->setChild(
            ...
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(
                    array(
                        'label'   => Mage::helper('amazon_products_amazon products')->__('Add Child Amazon Product'),
        ...
        $this->setChild(
            ...
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(
                    array(
                        'label'   => Mage::helper('amazon_products_amazon products')->__('Add Root Amazon Product'),
    ...
    {
        return $this->getUrl('*/amazon products_amazonproducts/jsonTree');
    }
    ...
    {
        return $this->getUrl('*/amazon products_amazonproduct/move');
    }
    ...
    public function getBreadcrumbsJavascript($path, $javascriptVarName)
    {
        ...
        $amazonproducts = Mage::getResourceSingleton('amazon_products_amazon products/amazonproduct_tree')
    ...
    {
        return $this->getUrl(
            "*/amazon products_amazonproduct/tree",
            array(
                '_current'=>true,
                'store'=>null,
                '_query'=>false,
