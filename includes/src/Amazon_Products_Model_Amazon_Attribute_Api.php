 ...
 */
/**
 * Amazon Product attribute API model
 *
 * @category    Amazon
 * @package     Amazon_Products
 * @author      Ultimate Module Creator
 */
class Amazon_Products_Model_Amazon_Attribute_Api extends Mage_Catalog_Model_Api_Resource
{
    /**
     * Amazon Product entity type id
     *
     * @var int
     */
    ...
    {
        $this->_storeIdSessionField = 'amazon_store_id';
        $this->_entityTypeId = Mage::getModel('eav/entity')->setType('amazon_products_amazon')
            ->getTypeId();
    }
    ...
    {
        $attributes = Mage::getResourceModel('amazon_products/amazon_attribute_collection');
        $result = array();
        foreach ($attributes as $attribute) {
            if ($this->_isAllowedAttribute($attribute)) {
                if (!$attribute->getId() || $attribute->getIsGlobal() == Amazon_Products_Model_Attribute::SCOPE_GLOBAL) {
                    $scope = 'global';
    ...
    public function options($attributeId, $store = null)
    {
        ...
        $attribute = Mage::getModel('amazon_products/amazon')
            ->setStoreId($storeId)
            ->getResource()
    ...
    {
        $model = Mage::getResourceModel('amazon_products/eav_attribute')
