 ...
 */
class amazon_products_Amazon Products_Model_Amazonproduct_Source extends Mage_Eav_Model_Entity_Attribute_Source_Abstract
{
    /**
     * Get all options
     *
    ...
    public function getAllOptions($withEmpty = false)
    {
        if (is_null($this->_options)) {
            $this->_options = Mage::getResourceModel('amazon_products_amazon products/amazonproduct_collection')
