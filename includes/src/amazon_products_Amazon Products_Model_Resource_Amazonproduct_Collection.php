 ...
 */
class amazon_products_Amazon Products_Model_Resource_Amazonproduct_Collection extends Mage_Catalog_Model_Resource_Collection_Abstract
{
    ...
    protected function _toOptionArray($valueField='entity_id', $labelField='name', $additional=array())
    {
        ...
        foreach ($this as $item) {
            if ($item->getId() == Mage::helper('amazon_products_amazon products/amazonproduct')->getRootAmazonproductId()) {
                continue;
            }
    ...
    public function addProductFilter($product)
    {
        ...
        if (!isset($this->_joinedFields['product'])) {
            $this->getSelect()->join(
                array('related_product' => $this->getTable('amazon_products_amazon products/amazonproduct_product')),
