 ...
 */
class amazon_products_Amazon Products_Model_Amazonproduct extends Mage_Catalog_Model_Abstract
{
    /**
     * Entity code.
     * Can be used as part of method name for entity processing
     */
    const ENTITY    = 'amazon_products_amazon products_amazonproduct';
    const CACHE_TAG = 'amazon_products_amazon products_amazonproduct';
     ...
     * @var string
     */
    protected $_eventPrefix = 'amazon_products_amazon products_amazonproduct';
    ...
    {
        parent::_construct();
        $this->_init('amazon_products_amazon products/amazonproduct');
    }
    ...
    public function getProductInstance()
    {
        if (!$this->_productInstance) {
            $this->_productInstance = Mage::getSingleton('amazon_products_amazon products/amazonproduct_product');
        }
     ...
     *
     * @access public
     * @return amazon_products_Amazon Products_Resource_Amazonproduct_Product_Collection
     * @author Ultimate Module Creator
     */
    ...
    {
        return Mage::getResourceModel('amazon_products_amazon products/amazonproduct_tree');
    }
    ...
    public function getTreeModelInstance()
    {
        if (is_null($this->_treeModel)) {
            $this->_treeModel = Mage::getResourceSingleton('amazon_products_amazon products/amazonproduct_tree');
        }
    ...
    {
        $parent = Mage::getModel('amazon_products_amazon products/amazonproduct')->load($parentId);
        if (!$parent->getId()) {
            Mage::throwException(
    ...
    public function getParentAmazonproduct()
    {
        if (!$this->hasData('parent_amazonproduct')) {
            $this->setData(
                ...
                Mage::getModel('amazon_products_amazon products/amazonproduct')->load($this->getParentId())
            );
        }
    ...
    protected function _beforeDelete()
    {
        if ($this->getResource()->isForbiddenToDelete($this->getId())) {
            Mage::throwException(Mage::helper('amazon_products_amazon products')->__("Can't delete root amazon product."));
        }
     ...
     *
     * @access public
     * @param amazon_products_Amazon Products_Model_Amazonproduct $parent
