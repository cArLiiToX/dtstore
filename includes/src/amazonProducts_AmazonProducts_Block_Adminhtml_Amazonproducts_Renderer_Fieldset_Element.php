 ...
 */
class amazonProducts_AmazonProducts_Block_Adminhtml_AmazonProducts_Renderer_Fieldset_Element extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    /**
    ...
    {
        $this->setTemplate('amazonproducts_amazonproducts/form/renderer/fieldset/element.phtml');
    }
     ...
     *
     * @access public
     * @return amazonProducts_AmazonProducts_Model_Resource_Eav_Attribute
     * @author Ultimate Module Creator
     */
     ...
     *
     * @access public
     * @return amazonProducts_AmazonProducts_Block_Adminhtml_AmazonProducts_Renderer_Fieldset_Element
     * @author Ultimate Module Creator
     */
    ...
    public function getScopeLabel()
    {
        ...
        if ($this->isScopeGlobal($attribute)) {
            $html.= Mage::helper('amazonproducts_amazonproducts')->__('[GLOBAL]');
        } elseif ($this->isScopeWebsite($attribute)) {
            $html.= Mage::helper('amazonproducts_amazonproducts')->__('[WEBSITE]');
        } elseif ($this->isScopeStore($attribute)) {
            $html.= Mage::helper('amazonproducts_amazonproducts')->__('[STORE VIEW]');
        }
        return $html;
    }
