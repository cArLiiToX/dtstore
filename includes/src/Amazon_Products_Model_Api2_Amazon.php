 ...
 */
/**
 * Amazon Product REST API model
 *
 * @category    Amazon
 * @package     Amazon_Products
 * @author      Ultimate Module Creator
 */
class Amazon_Products_Model_Api2_Amazon extends Mage_Api2_Model_Resource
{
    ...
    public function getAvailableAttributes($userType, $operation)
    {
        ...
        $entityType = Mage::getModel('eav/entity_type')->loadByCode('amazon_products_amazon');
