 ...
 */
class Amazon_Products_Block_Adminhtml_Products_Renderer_Fieldset_Element extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    /**
    ...
    {
        $this->setTemplate('amazon_products/form/renderer/fieldset/element.phtml');
    }
     ...
     *
     * @access public
     * @return Amazon_Products_Model_Resource_Eav_Attribute
     * @author Ultimate Module Creator
     */
     ...
     *
     * @access public
     * @return Amazon_Products_Block_Adminhtml_Products_Renderer_Fieldset_Element
     * @author Ultimate Module Creator
     */
    ...
    public function getScopeLabel()
    {
        ...
        if ($this->isScopeGlobal($attribute)) {
            $html.= Mage::helper('amazon_products')->__('[GLOBAL]');
        } elseif ($this->isScopeWebsite($attribute)) {
            $html.= Mage::helper('amazon_products')->__('[WEBSITE]');
        } elseif ($this->isScopeStore($attribute)) {
            $html.= Mage::helper('amazon_products')->__('[STORE VIEW]');
        }
        return $html;
    }
