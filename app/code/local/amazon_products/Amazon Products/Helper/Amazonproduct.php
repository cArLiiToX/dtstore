 ...
 */
class amazon_products_Amazon Products_Helper_Amazonproduct extends Mage_Core_Helper_Abstract
{
    ...
    public function getAttributeInputTypes($inputType = null)
    {
        $inputTypes = array(
            ...
            'file'          => array(
                'backend_model' => 'amazon_products_amazon products/amazonproduct_attribute_backend_file'
            ),
            'image'          => array(
                'backend_model' => 'amazon_products_amazon products/amazonproduct_attribute_backend_image'
            ),
        );
    ...
    public function amazonproductAttribute($amazonproduct, $attributeHtml, $attributeName)
    {
        $attribute = Mage::getSingleton('eav/config')->getAttribute(
            amazon_products_Amazon Products_Model_Amazonproduct::ENTITY,
            $attributeName
        );
