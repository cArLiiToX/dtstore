 ...
 */
class amazon_products_Amazon Products_Block_Adminhtml_Amazon Products_Renderer_Fieldset_Element extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    /**
    ...
    {
        $this->setTemplate('amazon_products_amazon products/form/renderer/fieldset/element.phtml');
    }
     ...
     *
     * @access public
     * @return amazon_products_Amazon Products_Model_Resource_Eav_Attribute
     * @author Ultimate Module Creator
     */
     ...
     *
     * @access public
     * @return amazon_products_Amazon Products_Block_Adminhtml_Amazon Products_Renderer_Fieldset_Element
     * @author Ultimate Module Creator
     */
    ...
    public function getScopeLabel()
    {
        ...
        if ($this->isScopeGlobal($attribute)) {
            $html.= Mage::helper('amazon_products_amazon products')->__('[GLOBAL]');
        } elseif ($this->isScopeWebsite($attribute)) {
            $html.= Mage::helper('amazon_products_amazon products')->__('[WEBSITE]');
        } elseif ($this->isScopeStore($attribute)) {
            $html.= Mage::helper('amazon_products_amazon products')->__('[STORE VIEW]');
        }
        return $html;
    }
