...
*/
class amazon_products_Amazon Products_Block_Adminhtml_Amazonproduct_Edit_Tab_Attributes extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset(
            'info',
            array(
                'legend' => Mage::helper('amazon_products_amazon products')->__('Amazon Product Information'),
                'class' => 'fieldset-wide',
            )
        );
        $attributes = $this->getAttributes();
        foreach ($attributes as $attribute) {
            $attribute->setEntity(Mage::getResourceModel('amazon_products_amazon products/amazonproduct'));
        }
    ...
    protected function _prepareLayout()
    {
        ...
        Varien_Data_Form::setFieldsetElementRenderer(
            $this->getLayout()->createBlock('amazon_products_amazon products/adminhtml_amazon products_renderer_fieldset_element')
        );
    }
    ...
    protected function _getAdditionalElementTypes()
    {
        return array(
            'file'     => Mage::getConfig()->getBlockClassName(
                'amazon_products_amazon products/adminhtml_amazonproduct_helper_file'
            ),
            'image'    => Mage::getConfig()->getBlockClassName(
                'amazon_products_amazon products/adminhtml_amazonproduct_helper_image'
            ),
