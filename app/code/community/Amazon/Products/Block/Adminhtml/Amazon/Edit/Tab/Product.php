 ...
 */
class Amazon_Products_Block_Adminhtml_Amazon_Edit_Tab_Product extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
     ...
     *
     * @access protected
     * @return Amazon_Products_Block_Adminhtml_Amazon_Edit_Tab_Product
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        ...
        if ($this->getAmazon()->getId()) {
            $constraint = '{{table}}.amazon_id='.$this->getAmazon()->getId();
        } else {
            $constraint = '{{table}}.amazon_id=0';
        }
        $collection->joinField(
            'position',
            'amazon_products/amazon_product',
            'position',
    ...
    {
        $products = array();
        $selected = Mage::registry('current_amazon')->getSelectedProducts();
     ...
     *
     * @access public
     * @param Amazon_Products_Model_Product
     * @return string
     * @author Ultimate Module Creator
     */
