 ...
 */
class Amazon_Products_Model_Resource_Amazon_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    public function addProductFilter($product)
    {
        ...
        if (!isset($this->_joinedFields['product'])) {
            $this->getSelect()->join(
                array('related_product' => $this->getTable('amazon_products/amazon_product')),
                'related_product.amazon_id = main_table.entity_id',
                array('position')
            );
