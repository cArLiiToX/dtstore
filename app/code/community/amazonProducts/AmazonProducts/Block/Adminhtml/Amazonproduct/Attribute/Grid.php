 ...
 */
class amazonProducts_AmazonProducts_Block_Adminhtml_Amazonproduct_Attribute_Grid extends Mage_Eav_Block_Adminhtml_Attribute_Grid_Abstract
{
    /**
     * Prepare amazon product attributes grid collection object
     *
     * @access protected
     * @return amazonProducts_AmazonProducts_Block_Adminhtml_Amazonproduct_Attribute_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('amazonproducts_amazonproducts/amazonproduct_attribute_collection')
            ->addVisibleFilter();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumnAfter(
            'is_global',
            array(
                'header'   => Mage::helper('amazonproducts_amazonproducts')->__('Scope'),
                'sortable' => true,
                'index'    => 'is_global',
                'type'     => 'options',
                'options'  => array(
