 ...
 */
class amazonProducts_AmazonProducts_Block_Adminhtml_Catalog_Product_Edit_Tab_Amazonproduct extends amazonProducts_AmazonProducts_Block_Adminhtml_Amazonproduct_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('amazonproducts_amazonproducts/catalog/product/edit/tab/amazonproduct.phtml');
    }
    ...
    public function getAmazonproductIds()
    {
        if (is_null($this->_amazonproductIds)) {
            $selectedAmazonproducts = Mage::helper('amazonproducts_amazonproducts/product')->getSelectedAmazonproducts($this->getProduct());
            $ids = array();
